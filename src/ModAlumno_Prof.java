...
public class ModAlumno_Prof extends JFrame implements ActionListener{
	int id;
	JFrame ventanaMA;
	...
	ModAlumno_Prof(int id) throws SQLException {
		this.id = id;
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getActionCommand().equals("Cancelar")) {
			...
			try {
				A3.cb_M1.setSelectedItem(mda.graAlumCons(id));
				A3.cb_M2.setSelectedItem(mda.gruAlumCons(id));
			} catch (SQLException e1) {
