...
public class A3 extends JFrame implements ActionListener {
	...
	int j1 = (screenSize.height - 310 -40) /2;  // Medida exclusiva para los paneles de profesor, que solo lleva 2
	int j2;
	...
	public A3() {
		...
		JP_altaAlumno.setBounds(w1, j1, 350, 310);
		...
		JP_altaPadre.setBounds(w2, j1, 350, 310);
		...
		JP_modAlumno.setBounds(w1, j1, 350, 310);
		...
		JP_modPadre.setBounds(w2, j1, 350, 310);
		...
		tabs.setTabComponentAt(1, lbl_Modi);
		tabs.setTabComponentAt(2, lbl_Cons);
	        	...
	        	public void valueChanged(ListSelectionEvent le) {
	        		...
	        		e_BAlum.addActionListener(new ActionListener() {
	        			public void actionPerformed(ActionEvent e) {
	        				...
	        				MySQL sql2 = new MySQL();
	        				try {
								ModAlumno_Prof ma = new ModAlumno_Prof(sql2.id_alumno(res[0], res[1], res[2], res[3], res[4]));
							} catch (SQLException e1) {
								JOptionPane.showMessageDialog(null, "Error en la base de datos",
										"¡Error!", JOptionPane.ERROR_MESSAGE);
								e1.printStackTrace();
			        	...
			        	public void valueChanged(ListSelectionEvent le) {
			        		...
			        		e_BAlum.addActionListener(new ActionListener() {
			        			public void actionPerformed(ActionEvent e) {
			        				...
			        				MySQL sq = new MySQL();
			        				try {
										ModTutor_Prof ma = new ModTutor_Prof(sq.id_padre(res[0], res[1], res[2], res[3]));
									} catch (SQLException e1) {
										JOptionPane.showMessageDialog(null, "Error en la base de datos",
												"¡Error!", JOptionPane.ERROR_MESSAGE);
										e1.printStackTrace();
